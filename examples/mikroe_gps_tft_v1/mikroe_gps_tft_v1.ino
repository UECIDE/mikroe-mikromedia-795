...
int NmeaInterval;
int x;                                              // NOTE: touch screen values
int y;
int z;
int screenNum = 1;
// ************************************************************************************************************
       ...
       if (touch.touched())   {                          // screen touch?
            if (touch.bufferEmpty())  {                 //  if no data in queue
                return;                                         //   bail out
                  ...
                  x = p.x;
                 /*---------------------- put your code here ----------------------------
     code to detect which button has been pressed can go here then use a case statement to do whatever
                 */
                  if(x > 30 && x < 140){                // i.e touched NAV button
                    if(y < 270 && y > 220){
                    tft.fillScreen(Color::Black);
                    screenNum = 1;
                    }
                  }
                  if(x > 200 && x < 300){                // i.e touched DATEbutton
                    if(y < 270 && y > 220){
                    tft.fillScreen(Color::Blue);
                    screenNum = 2;
                    }
                  }
                  if(x > 360 && x < 480){                // i.e touched FILE button
                    if(y < 270 && y > 220){
                    tft.fillScreen(Color::Blue);
                    screenNum = 3;
                    }
