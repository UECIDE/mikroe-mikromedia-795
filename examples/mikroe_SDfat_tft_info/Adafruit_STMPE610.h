...
#endif
*/
#define STMPE_ADDR 0x44 // change from 41
...
class Adafruit_STMPE610{
 public:
  Adafruit_STMPE610(int  cspin, int mosipin, int misopin, int clkpin);
  Adafruit_STMPE610(int cs);
  Adafruit_STMPE610(void);
  bool begin(int i2caddr = STMPE_ADDR);

  void writeRegister8(int reg, int val);
